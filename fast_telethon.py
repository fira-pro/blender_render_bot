"""
fast_telethon.py — Parallel upload/download for Telethon.

Based on parallel_file_transfer.py from mautrix-telegram, adapted by painor.
https://gist.github.com/painor/7e74de80ae0c819d3e9abcf9989a8dd6

Install `cryptg` for significantly faster AES encryption/decryption:
    pip install cryptg
"""
...
from typing import (
    AsyncGenerator, Awaitable, BinaryIO, DefaultDict, List, Optional,
    Tuple, Union,
)
...
log: logging.Logger = logging.getLogger("fast_telethon")
...
class ParallelTransferrer:
    ...
    async def download(
        ...
        log.debug(
            ...
            f"{connection_count} connections, {part_size}B parts, {part_count} parts"
        )
        ...
        while part < part_count:
            ...
            for task in tasks:
                ...
                yield data
                part += 1
                log.debug(f"Part {part}/{part_count} downloaded")
...
def stream_file(file_to_stream: BinaryIO, chunk_size: int = 1024):
    while True:
